...
/// 
[System.Serializable]
public class AnalysisResults : ScriptableObject 
{
    ...
    public AnalysisResultsData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new AnalysisResultsData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public AnalysisResultsData FindByKey(string key)
    //{
